    ...
    <div class="mr-auto flex-auto grow-0">
      <div class="flex items-center gap-1 text-[11px]">
        <span class="mx-2 self-center">
          <button @click="toggleDarkmode()" class="py-1 px-4 border-[1px] rounded-full border-gray-700 dark:border-gray-200">
            <svg class="icon icon-small transition-all delay-75 dark:text-gray-200" xmlns="http://www.w3.org/2000/svg"
