...
const MegaMenu = (props: any) => {
  const [selectedMainCategory, selectMainCategory] = useState(0);
  const dummyData: Array<MainCategory> = [
      ...
      categories: [
        {
          ...
          subCategories: [
            {
              key: 'electronic_01_01',
              title: 'کیف و کاور گوشی',
            },
            {
              key: 'electronic_01_02',
              title: 'پاوربانک (شارژر همراه)',
            },
            {
              key: 'electronic_01_033',
        ...
        },
        {
          ...
          subCategories: [
            {
              key: 'electronic_02_01',
              title: 'سامسونگ',
            },
            {
              key: 'electronic_02_02',
              title: 'هوآوری',
            },
            {
              key: 'electronic_02_03',
              title: 'اپل',
            },
            {
              key: 'electronic_02_04',
              title: 'شیائومی',
            },
            {
              key: 'electronic_02_05',
              title: 'آنر',
            },
            {
              key: 'electronic_02_06',
              title: 'نوکیا',
            },
          ],
        },
        ...
        },
        {
          ...
          subCategories: [
            {
              key: 'electronic_08_01',
              title: 'دوربین عکاسی دیجیتال',
            },
            {
              key: 'electronic_08_02',
              title: 'دوربین ورزشی و فیلم برداری',
            },
            {
              key: 'electronic_08_03',
        ...
        },
        {
          ...
          subCategories: [
            {
              key: 'electronic_09_01',
              title: 'لنز',
            },
            {
              key: 'electronic_09_02',
              title: 'کیف',
            },
            {
              key: 'electronic_09_03',
              title: 'کارت حافظه',
            },
            {
              key: 'electronic_09_04',
              title: 'کاغذ چاپ عکس',
            },
          ],
        },
        ...
        {
          key: 'electronic_11',
          title: 'پلی استیش، ایکس باکس و بازی',
          subCategories: [],
        },
        {
          key: 'electronic_12',
          ...
          subCategories: [
            {
              key: 'electronic_12_01',
              title: 'تجهیزات مخصوص بازی',
            },
            {
              key: 'electronic_12_02',
              title: 'مانیتور',
            },
            {
              key: 'electronic_12_03',
              title: 'کیس‌های اسمبل شده',
            },
            {
              key: 'electronic_12_04',
              title: 'قطعات داخلی کامپیوتر',
            },
            {
              key: 'electronic_12_05',
              title: 'ماوس',
            },
            {
              key: 'electronic_12_06',
              title: 'کیبورد',
            },
          ],
        },
        ...
        },
        {
          ...
          subCategories: [
            {
              key: 'electronic_14_01',
              title: 'یف، کوله و کاور',
            },
            {
              key: 'electronic_14_02',
        ...
        },
        {
          ...
          subCategories: [
            {
              key: 'electronic_21_01',
              title: 'تلفن، بی سیم و سانترال',
            },
            {
              key: 'electronic_21_02',
              title: 'فکس',
            },
            {
              key: 'electronic_21_03',
              title: 'پرینتر',
            },
            {
              key: 'electronic_21_04',
    ...
    },
    {
      ...
      categories: [
        ...
        {
          key: 'tools_05',
          title: 'لوازم مصرفی خودرو و موتووسیکلت',
          subCategories: [
            {
              key: 'tools_05_01',
              title: 'لاستیک و تایر',
      ...
      <div>
        {dummyData.map((category, index) => {
          return (
            <a
              key={category.key}
              className={`${classes.mainCategory} hover flex items-center py-3 text-right text-sm`}
              onMouseEnter={() => selectMainCategory(index)}
            >
  ...
  const MainCategory = () => {
    const mainCategory = dummyData[selectedMainCategory];

    return (
      <div className="w-full px-4">
        <div className="flex">
          <div className="w-4/5">
            <a className="flex cursor-pointer py-4 text-right text-[11px] text-gray-700">
              <span className="pl-1">همه </span>
  ...
  const Category = () => {
    ...
    return (
      <div className="flex h-[420px] flex-col flex-wrap pb-5">
        {mainCategory.categories.map((category) => {
          return (
            <>
              <Link href={category.key} key={category.key}>
                <a className="mt-1 flex  py-1 hover:text-red-600">
                  <span className="w-0.5 bg-red-600"></span>
                  <span className="pl-1 pr-2 font-bold"> {category.title}</span>

                  <svg className="h-3 w-3" fill="currentColor">
                    <use href="#chevronLeft"></use>
                  </svg>
                </a>
              </Link>
              {category?.subCategories?.map((subCategory) => {
                return (
                  <Link href={subCategory.key} key={subCategory.key}>
                    <a className="mt-1 flex py-1 text-[11px] text-gray-500  hover:text-red-600">
                      <span className="px-2"> {subCategory.title}</span>
                    </a>
                  </Link>
                );
              })}
  ...
  return (
    <div className="megaMenu mb-16 bg-white px-0 shadow-xl sm:mb-0">
      <div className="flex h-fit w-full justify-between">
        <div className="w-1/6 border-l border-gray-200">
          <MainCategoryList />
        </div>
        {selectedMainCategory >= 0 && <MainCategory />}
      </div>
    </div>
  );
};
